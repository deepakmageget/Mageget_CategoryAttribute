...
namespace Mageget\CategoryAttribute\Plugin\Block;
...
class Topmenu
{
    ...
    public function beforeGetHtml(
        ...
        // $collection->addAttributeToSelect('custom_select_options');
    ...
    private function getCategoryAsArray($category, $currentCategory, $isParentActive)
    {
        ...
        return [
            ...
            'custom_select_options' => $category->getData('custom_select_options'),
    ...
    protected function getCategoryTree($storeId, $rootId)
    {
        ...
        //     echo "<pre>";
        //     print_r($category1->getData('custom_select_options'));  
        //     }
        //     exit;
    }
